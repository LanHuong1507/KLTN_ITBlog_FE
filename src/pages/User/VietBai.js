...
const VietBai = () => {
    ...
    const validateForm = () => {
        ...
        if (!slug) {
            ...
            errors.slug = "Đường dẫn chỉ cho phép chữ thường, số và dấu gạch nối. Ví dụ: 'my-post'.";
        }
        ...
        if (!tags) {
            ...
            errors.tags = "Từ khóa không hợp lệ. Vui lòng sử dụng ký tự chữ và số, cách nhau bởi dấu ','. Ví dụ: 'tag1,tag2'.";
        }
                ...
                <div className="archive-header text-center mb-50">
                    <div className="container">
                        ...
                        <div className="breadcrumb">
                            ...
                            <Link to="/" rel="nofollow">Trang Chủ</Link>
                            <span />
                            <Link to="/tai-khoan" rel="nofollow">Tài Khoản</Link>
                            <span /> Viết Bài Mới
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row mb-50">
                                <div className="col-lg-8 col-md-12">
                                    <div className="sidebar-widget mb-50">
                                        ...
                                        {validationErrors.content && <p className="text-danger">{validationErrors.content}</p>}
                                    </div>
                                </div>
                                                ...
                                                <div className="col-md-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            required
                                                        />
                                                        {validationErrors.slug && <p className="text-danger">{validationErrors.slug}</p>}
                                                    </div>
                                                </div>
                                                <div className="col-md-12">
                                                    <div className="form-group">
                                                        ...
                                                        />
                                                        {validationErrors.categories && <p className="text-danger">{validationErrors.categories}</p>}
                                                    </div>
                                                </div>
                                                <div className="col-md-12">
                                                    <div className="form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            required
                                                        />
                                                        {validationErrors.tags && <p className="text-danger">{validationErrors.tags}</p>}
                                                    </div>
                                                </div>
                                                <div className="col-md-12">
                                                    <div className="form-group">
